...
namespace Steam4NET
{
	...
	public class ISteamUtils007 : InteropHelp.NativeWrapper<ISteamUtils007VTable>
	{
		...
		[return: MarshalAs(UnmanagedType.I1)]
		[UnmanagedFunctionPointer(CallingConvention.ThisCall)] private delegate bool NativeShowGamepadTextInputEESUS( IntPtr thisptr, EGamepadTextInputMode eInputMode, EGamepadTextInputLineMode eInputLineMode, string szText, UInt32 uMaxLength, string pUnk );
		public bool ShowGamepadTextInput( EGamepadTextInputMode eInputMode, EGamepadTextInputLineMode eInputLineMode, string szText, UInt32 uMaxLength, string pUnk ) 
		{
			return this.GetFunction<NativeShowGamepadTextInputEESUS>( this.Functions.ShowGamepadTextInput20 )( this.ObjectAddress, eInputMode, eInputLineMode, szText, uMaxLength, pUnk ); 
		}
